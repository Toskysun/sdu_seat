...
object SSLHelper {
    ...
    val unsafeSSLSocketFactory: SSLSocketFactory by lazy {
        try {
            ...
            if (factory is SSLSocketFactory) {
                factory
            } else {
                throw IllegalStateException("SSLSocketFactory not created")
            }
        } catch (e: Exception) {
     ...
     */
    val unsafeHostnameVerifier: HostnameVerifier = HostnameVerifier { hostname, _session ->
